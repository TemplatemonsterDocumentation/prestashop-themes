...
<p><strong>Description of parameters:</strong></p>
    ...
    <li>
        <dl class="inline-term">
            ...
            <dd>setting the display of Blog related modules. It often requires additional settings, therefore it
                is
                recommended that you install additional modules in the same way that standard PrestaShop modules
                are
                installed.
            </dd>
        </dl>
    ...
    <li>
        <dl class="inline-term">
            ...
            <dd>you can add additional styles in this field. Be careful using the classes that are already used
                in
                the
                theme, since some conflicts may occur.
            </dd>
        </dl>
    </li>
    <li>
        <dl class="inline-term">
            ...
            <dd>is used to regenerate blog images in case image dimensions were changed or the new type of image
                was
                added. To regenerate, select <strong>Yes</strong> and click <strong>Regenerate</strong>.
            </dd>
        </dl>
    </li>
</ol>
<p class="alert alert-danger"><strong>ONLY AFTER THIS</strong> other blog related modules can be installed. The
    process of removal is opposite <strong>FIRST,
        YOU SHOULD DELETE ALL RELATED MODULES</strong> and only then delete Smart Blog module. </p>
...
<p>The module generating the new feed for your Blog.</p>

<p><strong>Has several settings in the admin panel:</strong></p>
...
<p>This block shows up in the left/right column and is used to sort posts by period
    of time (month) .</p>

<p><strong>It does not have any additional settings.</strong></p>


<h4>Smart Blog Categories</h4>

<p>This block shows up in the left/right column and is used to sort posts by
    category.</p>
...
<p>This block shows up only in <strong>homepagecontent</strong> hook and is used to
    display latest posts on the home page.</p>
...
<p>This block shows up in the left/right column and is used to display the latest
    comments added for the Blog posts.</p>
...
<ol class="index-list">
    <li>
        <dl class="inline-term">
            ...
            <dd>numbers of comments shown in
                the block.
            </dd>
        </dl>
    </li>
...
<p>This block shows up on the post single page and allows to share this post in
    social networks.</p>
...
<p>This block shows up in the left/right column and is used to display the most
    popular posts viewed.</p>
...
<ol class="index-list">
    <li>
        <dl class="inline-term">
            ...
            <dd>numbers of recent posts shownin the block.</dd>
        </dl>
    </li>
</ol>
...
<p>This block shows up on the post single page and is used to show up related
    posts.</p>
...
<ol class="index-list">
    <li>
        <dl class="inline-term">
            ...
            <dd>number of related postsshown in the block.</dd>
        </dl>
    </li>
</ol>
...
<p>This block shows up in the left/right column and is used to search through the
    blog.</p>
...
<p>This block shows up in the left/right column and is used to display tags used in
    the blog.</p>
