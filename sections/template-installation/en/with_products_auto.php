...
<ol class="index-list">
    ...
    <li>
        <p>Select and upload sample data files from <strong>'sample_data'</strong> directory of your template package. You can do this using the <strong>"Browse local files"</strong> button or dragging sample data files to the browser window.</p>
        <figure class="img-polaroid">
    ...
    <li>
        <p>Then Sample data installer will automatically configure your store and other modules. This can take several minutes.</p>
        <figure class="img-polaroid">
            <img src="img/auto-install-5.png" alt=""/>
        </figure>
    </li>
    <li>
        <p>When sample data is installed successfully, you need to perform the last step - regenerate images. Click <strong>"Go To Regenerate Page"</strong> button.</p>
        <figure class="img-polaroid">
