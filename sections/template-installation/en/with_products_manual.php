...
<ol class="index-list">
    ...
    <li>Upload <strong>/img/</strong>, <strong>/modules/</strong> and <strong>/themes/</strong> folders to PrestaShop
        root directory.
    </li>
</ol>
...
<p>Sample data is provided as an .SQL file. It is located in the <strong>theme/manual_install/</strong> of the template
    package and is called <strong>dump.sql</strong>.</p>
<p>The dump.sql file can be installed using the phpMyAdmin tool or some other database management tool in your hosting
    control panel. This detailed tutorial on <a target="_blank"
...
<p class="alert alert-warning">Before you proceed, please back up your database. You can check the detailed video
    tutorial on <a target="_blank" href="/help/phpmyadmin-how-to-backup-a-database.html">how to back up a database</a>.
</p>
...
<p>From the PrestaShop admin panel, go to <strong>Preferences > Themes</strong>, choose your template in the <strong>Themes</strong>
    section and click <strong>Save</strong>.</p>