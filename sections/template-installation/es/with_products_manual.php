...
<ol class="index-list">
    ...
    <li>Suba carpetas <strong>/img/</strong>, <strong>/modules/</strong> y <strong>/themes/</strong> al directorio raíz de PrestaShop.</li>
</ol>
...
<p>Los datos de ejemplo se proporcionan como un archivo .SQL. Se encuentra en esta ruta del paquete de plantilla <strong>theme/manual_install/</strong> y se llama <strong>dump.sql</strong>.</p>
<p>El archivo dump.sql se puede instalar utilizando la herramienta phpMyAdmin o alguna otra herramienta de gestión de Bases de Datos en el panel de control de Alojamiento. Este tutorial detallado sobre <a target="_blank" href="/help/phpmyadmin-how-to-import-sample-data-dump-file-phpmyadmin.html">cómo instalar archivos SQL</a> puede ayudarle.</p>
<p class="alert alert-warning">Antes de continuar, haga una copia de seguridad de su Base de Datos. Puede consultar el tutorial de vídeo detallado <a target="_blank" href="/help/phpmyadmin-how-to-backup-a-database.html">Cómo hacer una copia de seguridad de una base de datos</a>.</p>
<p class="alert alert-danger">Asegúrese de que la versión del motor de PrestaShop coincida con los requisitos de la plantilla. De lo contrario, la Base de Datos se dañará.</p>
<p>Cuando haya terminado de instalar el archivo dump.sql, tendrá que activar la plantilla.</p>
<p>Desde el Panel de Administración de PrestaShop, vaya a <strong>Preferencias > Temas</strong>, elige tu plantilla en la sección <strong>Temas</strong> y haga click en el botón <strong>Guardar</strong>.</p>