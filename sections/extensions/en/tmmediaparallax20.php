...
<h4 id="layouts-list">Parallax layers list.</h4>
...
<ul class="index-list">
    <li>Image-background - image used as a parallax background
    ...
    <li>Video-background - video used as a parallax background
        <ul class="marked-list">
            <li>Item status - item status (parallax will not be displayed if it's disabled)</li>
            <li>Layout speed - digit value from 0 to 2, which defines main parallax block speed</li>
            <li>Offset - main layer indent on the Y axis</li>
...
<h4 id="layout-info">Warnings and recommendations</h4>
<ul class="index-list">
    ...
    <li>The smaller is the size of the uploaded video, the better.</li>
</ul>