...
<h4 id="tmegalayout-mainpanel">Integration module to the theme</h4>
<p class="alert alert-warning">Without this step done your presets will not be displayed on the frontend.</p>
<ul class="index-list">
    <li>Top column. In order to add custom preset to the topColumn hook you need to perform the following:
        <ul class="marked-list">
...
{/if}</pre>
    ...
    <li>Home.  In order to add custom preset to the Home hook you need to perform the following:
        <ul class="marked-list">
...
{/if}</pre>
    ...
    <li>Footer.  In order to add custom preset to the Footer hook you need to perform the following:
        <ul class="marked-list">
            <li>Open the <strong>/themes/your_theme/footer.tpl</strong> file for editing.</li>
            <li>Locate the following code:
                <pre class="prettyprint">
...
<figure class="img-polaroid"><img src="img/tmmegalayout-main-panel.png" alt="" /></figure>
...
<p class="alert-warning alert">There is no option to restore the preset after removing.</p>
<ul class="index-list">
    <li>
...
<ul class="index-list">
    ...
    <li>
        <p>You'll see a pop-up window, fill in the 'Enter row classes'(2) field there and press on a 'Confirm'(3) button.</p>
...
<p class="alert-warning alert">Preset item removing will also cause its child items and their styles deleting.</p>
<ul class="index-list">
    <li>
...
<ul class="index-list">
    ...
    <li>
        <p>Fill in the fields (col-xs*, col-sm*, col-md*, col-lg - bootstrap classes)  in the pop-up window and press on 'Confirm'.</p>
...
<ul class="index-list">
    <li>
        ...
        <ul class="marked-list">
            <li>background-image (background image) - the argument is a link to the image on 'none' value. The image is picked from the ~/images/cms/ folder.</li>
            ...
            <li>background-repeat (background repeat) - all of the available options are listed in the dropdown.</li>
...
<h4>Items styles removing.</h4>
<ul class="index-list">
    <li>
        <p>In order to remove items styles open the items styling section and press on  'Clear styles'(1)</p>
