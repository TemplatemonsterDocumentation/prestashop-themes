...
<p>Этот модуль позволяет регистрироваться и выполнять вход систему с помощью данных страниц клиентов в социальных сетях, таких как Facebook и Google.</p>
...
<p class="alert alert-info">Получите более подробную информацию, перейдя по ссылкам: <a
...
<p class="alert alert-warning">
     Путь перенаправления должен быть тем же, что был указан при создании приложения Google.
</p>
