...
<p>This module allows you to display categories with products, banners, video (Youtube, Vimeo and custom video), HTML
...
<p>After module has been installed, you can add the required blocks with category products, previously added banners,
    video and HTML content.</p>
...
<ul class="marked-list">
    ...
    <p>In order to add the new row, press the "Add row" button. Then choose one of the eight layouts presented in the
        following window.</p>
</ul>
...
<p>In order to add items, click on one of the layout cells. You'll see five buttons listing the available items of
    certain type.</p>
...
<p>After clicking on one of the items, it will be added to the layout cell. You can fill in the layout with different
    blocks this way.</p>
...
<p>In order to add a new banner, click the 'Add new banner' button. Next, fill in the required fields in the form that
    appears.</p>
...
<p>In order to add a new video, click the 'Add new video' button. Next, fill in the required fields in the form that
    appears.</p>
<figure class="img-polaroid"><img src="img/tmmosaicproducts-10.png" alt=""/></figure>
<ul class="marked-list">
    <li><strong>Enter Video name</strong> - video title, this field is required (at least for the default language).
    </li>
    <li><strong>Video Link/Path</strong> - link to the video (youtube, vimeo or custom video), this field is required
        (at least for the default language).
    </li>
    <li><strong>Allow autoplay</strong> - defines if video starts automatically right after the player has been loaded.
    </li>
...
<p>In order to add new HTML content, press the 'Add new HTML' button. Next, fill in the required fields in the form that
    appears.</p>
<figure class="img-polaroid"><img src="img/tmmosaicproducts-11.png" alt=""/></figure>
<ul class="marked-list">
    <li><strong>Enter HTML item name</strong> - HTML content title, this field is required (at least for the default
        language).
    </li>
    <li><strong>Specific class</strong> - block's CSS class.</li>
...
<p>In order to add a new slider, press the 'Add new slider' button. Next, fill in the required fields in the form that
    appears.</p>
<figure class="img-polaroid"><img src="img/tmmosaicproducts-12.png" alt=""/></figure>
<ul class="marked-list">
    <li><strong>Enter Slider item name</strong> - slider title, this field is required (at least for the default
        language).
    </li>
...
<p>In order to add a new slide, click the 'View' button in the slider form and then press the 'Add new' button in a
    window that appears. Then fill in the required fields.</p>
...
<ul class="marked-list">
    ...
    <li><strong>Banner/Video/Html list</strong> - choose the element of the previously selected type, this field is
        required.
    </li>
