...
<ul class="index-list">
    <li>
        <p>Click each tab to see the available options in this section. They will be described further. <br>
            Each option has a hint - short description, which appears in the right when you hover the option (1).</p>
    ...
    <li>
        <p>When the list of selected products complies with all requirements, click the 'Process' button (1).</p>
...
<h5>Information</h5>
<p>The section allows to configure the following options:</p>
<figure class="img-polaroid"><img src="img/tmproductsmanager-10.png" alt=""/></figure>
<ul class="marked-list">
    <li><strong>Enable/Disable products</strong> - set the on/off status of your products.</li>
    <li><strong>Available for order</strong> - make some products available or unavailable for order.
        <p class="alert alert-warning small">
            <span>NOTE: if 'Available for order' is set to 'Yes' for the products with hidden prices, their prices will automatically become visible again.</span>
        </p>
    </li>
    <li><strong>Show price</strong> - show or hide product price.
        <p class="alert alert-warning small">
            <span>NOTE: if you set 'Show price' to 'No' for the products, which are available for order, they will be automatically changed to unavailable.</span>
        </p>
    </li>
...
<h5>Price</h5>
<p>In this section you can change options concerning product price.</p>
...
<h5>Associations</h5>
<p>Here you can change options connected with product relations.</p>
<figure class="img-polaroid"><img src="img/tmproductsmanager-12.png" alt=""/></figure>
<ul class="marked-list">
    <li><strong>Change brand</strong> - change brand of selected items.</li>
    <li><strong>Change default category</strong> - choose the category which will be set as default for some products.
        <p class="alert alert-warning small">
...
<h5>Quantity</h5>
<p>This option allows to set the product quantity or increase/decrease current quantity by a certain amount.</p>
