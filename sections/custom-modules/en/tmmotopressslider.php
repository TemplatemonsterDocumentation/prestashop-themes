...
<ul class="index-list">
	<li>Upload module to the /modules folder.</li>
	<li>
		<p>Go to Admin panel -> Modules and Services -> Modules and Services (1), find the module (2) and click the 'Install' button (3).</p>
	...
	<li>
		<p>
			When the module is successfully installed you can see the 'MotoPress Slider' menu appeared at the bottom of your admin panel (1).<br>
...
<p>When you clicked the 'Add Slider' button, there's an option to choose if it should be 'Custom Slider' or 'Product Slider'.</p>
<figure class="img-polaroid">
    <img src="img/mpslider03_slider_add.png" alt=""/>
</figure>
<p>The difference between these two types is the following: Product slider is created from the products of your store, though in Custom Slider you can add as much slides as you wish, customizing them according to your needs.</p>
...
<ul class="marked-list">
	<li><strong>Slider title</strong> - the title of the slider (example: Slider1); it is required when you have several sliders and have to distinguish them.</li>
	<li><strong>Slider alias</strong> - the unique alias that will be used in shortcodes for embedding the slider (example: slider1); must be unique.</li>
	...
	<li><strong>Force full size grid</strong> - makes grid stretch to parent container (but you still need to set grid width and height).</li>
...
<ul class="marked-list">
	...
	<li><strong>Visible</strong> - min. and/or max. screen resolutions when the slider is visible (can be set using the presets: phone / tablet / desktop).</li>
	<li><strong>Initialization delay</strong> - the delay bofore slider initialization (should be set in milliseconds).</li>
...
<ul class="marked-list">
	<li><strong>Link slides to product page</strong> - enable if you want the product page to be opened after the click on slide with the product.</li>
	<li><strong>Open in new window</strong> - enable this option to open the product page in new window.</li>
	<li><strong>Categories</strong> - categories with products to show in slider (Ctrl + click to select several categories).</li>
	...
	<li><strong>Number of first results to skip (offset)</strong> - the number of first slides which will not be shown.</li>
...
<p>Below there's a list of products which will be displayed in slider. After you've made any changes in settings, press the 'Preview products' button (1).</p>
<figure class="img-polaroid">
...
<p>MotoPress Slider contains the Style Editor. That allows customizing slide layers, their styles and texts using preview area and avoiding any manual changes of code or CSS rules.</p>
...
<ul class="index-list">
	...
	<li>
		<h6>Color</h6>
		<p>In the 'Color' tab there are two variants of background color type - background color and gradient. Choose the option and the preferable color.</p>
		<figure class="img-polaroid">
	...
	<li>
		<h6>Video</h6>
		<p>You can add video to your slide. To add video choose sources for different video formats and set other parameters for video display. You'll need to upload a video in MP4, WEBM or OGG format and provide the video file URL in Video tab.</p>
	...
	<li>Click on 'Save slide' button when you are done making changes.</li>	
</ul>
...
Above the 'Layer Settings' area there are four tabs for adding the needed content (3). After you've chosen what element you want to add, you can go further with detailed customization. <br>
The great feature is that these contents are added as individual layers, so you can drag them up and down to set their order in the 'Layers Sorting' section (2).</p>
...
<ul class="marked-list">
	...
	<li>If 'Whitespace' is set to 'Normal', the text will be wrapped normally. If 'No-wrap' is chosen, the wrapping will be ignored (3).</li>
	<li>In the second column you can control the element animation - how, how long and when it should start and end (4) within the duration of the slide (which is shown below for your convenience (5); to change it go to Slider Settings -> Slideshow delay). You can also preview the animation in the window that appears after clicking the 'Edit' button. Choose the duration, ease function, animation effect and press 'Play' to preview. Then click 'Apply' when it meets your expectations.</li>
</ul>
<p>Settings described above are similar for each element, that's why only options from the third column will be mentioned further.</p>
<figure class="img-polaroid">
    <img src="img/mpslider19_slide_add_text_3.png" alt=""/>
</figure>
<ul class="marked-list">
	<li>The text itself can be added in the textarea which comes next (6).</li>
	<li>The text style can be chosen from the presets in the dropdown (7), edited after you've pressed the 'Edit' button (8), and disabled clicking the 'Remove' button (9). After the text style has been edited, press the 'Apply Style' button. If you want to edit and save the existing style, press 'Duplicate' button, edit and save it. To create from scrach the style which will be often applied, click the 'Create new preset' and edit it.</li>
...
<p>After you've made changes to your slide, don't forget to click the 'Save slide' button (1), then press 'Close' (2) or navigate between other slides (3).</p>
<figure class="img-polaroid">
    <img src="img/mpslider24_slide_save.png" alt=""/>
</figure>

<h4>Import and Export Slider</h4>
<h6>Import & Export Slider is very useful if you need to transfer any Slider to different websites. You do not need to spend much time for re-building sliders from scratch any more. If you are a developer you can create sliders on your website, show them them to your customers and import sliders to customers' websites.</h6>
