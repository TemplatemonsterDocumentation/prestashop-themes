...
<ul class="marked-list">
    ...
    <li><strong>Marker</strong> - adding a custom marker.</li>
    <li><strong>Custom text</strong> - adding custom text.</li>
</ul>
...
<ul class="marked-list">
    ...
    <li><strong>Zoom on scroll</strong> - enable/disable map zoom on scroll.</li>
    <li><strong>Map controls</strong> - enable/disable map controls.</li>
    <li><strong>Street view</strong> - enable/disable street view.</li>
    <li><strong>Animation marker</strong> - enable/disable animation marker.</li>
    <li><strong>Popup</strong> - enable/disable popup windows with store information.</li>
</ul>