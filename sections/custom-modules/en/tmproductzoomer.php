...
<p>This module is an alternative solution for the standard product image zoom on the single product page. It's fully
    ...
    module is based on the <a href="//igorlino.github.io/elevatezoom-plus/" target="_blank">Elevatezoom Plus</a> plugin.
</p>
<h4>Installation and removing</h4>
<p>The module is installed and deleted like any other Prestashop module. After module has been installed the standard
    product zoom effect will be automatically disabled. After deleting the module standard effect should be enabled back
    manually (if needed) in the <strong>Preferences -> Products -> Enable JqZoom instead of Fancybox on the product
        page</strong> section.</p>
...
<ul class="index-list">
    ...
    <li><strong>Change image on hover</strong> - switch the main image on thumbnail hover (by default is set to switch
        on click).
    </li>
    <li><strong>Responsive</strong> - allows to the use adaptive functionality for plugin display on the mobile devices.
    </li>
    <li><strong>Zoom Type</strong> - choose the type of the enlarged image display mode
        <ul>
            <li><strong>window</strong> - the enlarged image shows up next to the main image in one of the available
                (16) positions
            </li>
        ...
        <div class="alert alert-info"><span>The mobile devices (&lt; 768) have "lens" mode activated instantly.</span>
        </div>
    </li>
    <li><strong>Extended settings</strong> - enables advanced settings for the experienced users. You can see the link
        to the official <a href="//igorlino.github.io/elevatezoom-plus/api.htm" target="_blank"> documentation for more
            details</a> next to it.
    </li>
</ul>
...
<ul class="index-list">
    ...
    <li><strong>Cursor</strong> - cursor type on the magnified image hover. The following options are available:
        default, cursor, crosshair (available for all types).
    </li>
    ...
    <li><strong>Image Crossfade</strong> - main image blur outside the hover area (the lens) - available for window,
        lens.
    </li>
    <li><strong>Magnified image window settings</strong> - available for window.
        ...
        <ul class="marked-list">
            ...
            <li><strong>Zoom Window Position</strong> - window position choice relatively to the main image (the
                positions available are presented on the image below this field)
            </li>
    ...
    <li><strong>Zoom Lens</strong> - zoom lens (available for window, lens).
        ...
        <ul class="marked-list">
            ...
            <li><strong>Lens Shape</strong> - lens type. It can take the following values: circular/rounded or
                squared/rectangular
            </li>
            ...
            <li><strong>Contain Lens Zoom</strong> - the restriction of the lens overflow outwards the main image
                container
            </li>
        </ul>
    </li>
...
<div class="alert alert-info">If you switch the zoom type, advanced options set is changed accordingly to show only the
    available parameters for the type selected.
</div>
<div class="alert alert-warning">Be careful when editing the extended settings. If the settings are set incorrectly, the
    effect can be ugly.
</div>