...
<?php } ?>
<p>The module displays images in a 3D effect and enables users to rotate them in 360 degrees. The rotation can start automatically on page load, or the client can rotate the 'image' manually, dragging the left mouse button.</p>
...
<ul class="marked-list">
    ...
    <li><strong>Select a product</strong>(appears if 'Enable on Home' is set to 'Yes') - choose a product which should be displayed in 360 view.</li>
...
<ul class="index-list">
    <li>
        <p>Navigate to Catalog -> Products in your admin panel (1), choose the product and click the 'Edit' button (2).</p>
        <figure class="img-polaroid">
    ...
    <li>
        ...
        <p class="alert alert-warning">To make the rotation smooth, add more images and make a very slight change in position while making photos.</p>
    </li>
    <li>
    ...
    <li>
        <p>To disable 360 view on the Homepage, simply go to 360 view settings and switch the 'Enable on Home' option to 'No'.</p>
    </li>
    <li>
