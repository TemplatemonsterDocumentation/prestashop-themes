...
<ul class="index-list">
    <li>Upload the video files and preview images to modules/tmvideobackground/video folder (or any other folder on
        ...
        same names (ocean.jpg, ocean.gif, ocean.png).
    </li>
    <li><p>In your admin panel open <strong>Video background module</strong> (Modules -> Front Office Features -> Video
            background module) and perform
        ...
        <ul class="marked-list">
            ...
            <li>
                <dl class="inline-term">
                    ...
                    <dd>name of your video files. Only name should be added (there is no need to write the format). For
                        example, "ocean".
                    </dd>
                </dl>
            </li>
