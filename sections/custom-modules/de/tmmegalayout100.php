...
<?php if ($project == 'eveprest') { ?>
    <div>
        ...
        <p style="margin-top: 0;" class="small text-secondary">Mode, Elektronik, Ersatzteile, Möbel, Ein Produkt
</p>
    </div>
<?php } ?>
...
<ul class="index-list">
    ...
    <li>
        <p>Eigenschaften:</p>
        <ul class="marked-list">
            <li><p>Dieses Modul enthält 5 Hooks: 'Header', 'Top Column', 'Home', 'Footer' und 'Product Footer'.</p></li>
