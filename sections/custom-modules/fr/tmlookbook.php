...
<?php } ?>
<h5>Requirements:</h5>
<p>This module allows to create lookbooks and combine them to collections. In their turn, lookbooks allow to view the
    products directly on the model. Also, if a product is marked in the lookbook, the module displays the lookbook link
...
<ul class="index-list">
    ...
    <li>
        ...
        <ul class="marked-list">
            <li><strong>Status</strong> - this option allows to disable or enable the collection display on the
                collections page.
            </li>
            ...
            <li><strong>Template</strong> - the template for the lookbooks of this collection. When you select a
                template, you select the way the lookbooks of this collection will be displayed on the page.
            </li>
        </ul>
    </li>
    <li>
    ...
    <li>
        <p>The collection has been created. You can edit it by pressing the 'Edit' (3) button, or you can proceed to the
            next step and create lookbooks for the collection.</p>
        <figure class="img-polaroid">
...
<ul class="index-list">
    ...
    <li>
        ...
        <ul class="marked-list">
            <li><strong>Status</strong> - the lookbook status, the option defines whether the lookbook will be
                displayed.
            </li>
            <li><strong>Name</strong> - the name of the look.</li>
            <li><strong>Description</strong> - the description of the look.</li>
            <li><strong>Image</strong> - the main image of the look, here you can mark the products and descriptions.
            </li>
        </ul>
    </li>
    <li>
...
<ul class="index-list">
    ...
    <li>
        ...
        <ul class="marked-list">
            <li><strong>Type</strong> - this is the point type, it has two values 'Product' and 'Content'. The product
                type allows to select a product that will be attached to the point, and content type allows to add
                content (name, description, html) to the point.
            </li>
            <li><strong>Product</strong> - selecting a product for the point. It appears, if the selected type is
                'Product'.
            </li>
            <li><strong>Name</strong> - the name attached to the point. This field is available, only if the type
                'Content' is selected.
            </li>
            <li><strong>Description</strong> - the point description or coding. Available only if the type 'Content' is
                selected.
            </li>
        </ul>
    </li>
    <li>
        <p>After having selected the needed options, press the 'Save' (2) button, hotspot will be created and displayed
            on the page.</p>
        <figure class="img-polaroid">
