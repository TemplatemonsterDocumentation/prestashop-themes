...
<?php if ($project == 'eveprest') { ?>
    <div>
        ...
        <p style="margin-top: 0;" class="small text-secondary">Moda, Elettronica, Ricambi, Mobilio, Uno
            Prodotto</p>
    </div>
<?php } ?>
...
<h6>
Il modulo fornisce un'opzione per modificare la posizione del modulo e impostare la griglia per 3 ganci:
...
<h4>Hooks</h4>
<p>Per impostazione predefinita, il modulo dispone di 5 ganci:</p>
<ul class="index-list">
    <li>'Header' È un gancio che combina 2 ganci standard: displayNav e displayTop. Questo gancio corrisponde al
        intestazione sito web.
    </li>
    <li>'Top Colonna' corrisponde all'originale displayTopColumn hook. Questo gancio viene subito dopo il gancio Header.
    </li>
    ...
    <li>'Prodotto Footer' corrisponde all'originale hook DisplayFooterProduct, che viene visualizzato nella pagina del prodotto
        Footer.
    </li>
</ul>
...
<ul class="index-list">
    ...
    <li>
        <p>In the following pop-up window fill in all the needed fields (you may refer to the documentation 'Styling'
            section), and press 'Save' (2) button.Nella seguente finestra popup compilare tutti i campi necessari (si può fare riferimento alla documentazione 'Styling'
...
<h5>Aggiungere la classe CSS personalizzata alla rigaAdding custom CSS class to the row</h5>
...
<p class="alert alert-warning"><span>Fare attenzione quando si aggiungono moduli alla preselezione, alcuni dei moduli sono auspicabili da utilizzare se non modificano il layout visibile, ad esempio il modulo per statistiche.</span>
</p>
<ul class="index-list">
    <li>
...
<ul class="index-list">
    <li>
        <p>Per importare il preimpostato, è necessario aprire il file <strong>Strumenti (1)</strong> Scheda e scegliere <strong>'Importa'
                (2)</strong>.</p>
...
<p>L'ottimizzazione degli stili e degli script aggiunge esclusioni per i moduli nella sezione Intestazione, in base al loro utilizzo nei preset. Questo
    consente di accelerare la velocità di caricamento della pagina. L'ottimizzazione funziona in modalità di prova.</p>
...
<ul class="index-list">
    <li>
        ...
        <ul class="marked-list">
            <li>Backgrounbackground-image (immagine di sfondo) - l'URL dell'immagine o il valore 'none'. L'immagine viene selezionata dal file
                ~ /images/cms/cartella styles. Descrizione dei campi:
            </li>
