...
<?php if ($project == 'impresta') { ?>
    ...
    <!--    </div>-->
<?php } ?>
<p>Этот модуль предназначен для создания пользовательских макетов (пресетов) для хуков и отображения их на сайте вместо
    позиций по умолчанию. Это преимущество модуля позволяет Вам создавать различные разметки и изменять их в
...
<ul class="index-list">
    ...
    <li>
        ...
        <ul class="marked-list">
            ...
            <li><p>Модуль не позволяет Вам настраивать различные модули. Вы не можете установить различные настройки
                    модулей для различных пресетов.</p></li>
        </ul>
    </li>
</ul>
<h6>Модуль предоставляет Вам возможность изменить положение модуля и настроить сетку на 3 хука: displayTopColumn,
    displayHome, displayFooter. Изменение позиций модулей в разделе 'Модули и службы -> Позиции' не повлияет на позиции
    модулей в пресете. Если модуль не был добавлен в хук, его нельзя добавить в пресет.</h6>
...
{/if}</pre>
    ...
    <li><p>Домашний. Для того чтобы добавить пользовательский пресет в хук "Домашний", внесите следующие изменения:</p>
        <ul class="marked-list">
            <li>Откройте файл <strong>/themes/your_theme/index.tpl</strong> для редактирования.</li>
            <li>Найдите следующий фрагмент кода:
                <pre class="codebox">
...
{/if}</pre>
    ...
    <li><p>Header. Для того чтобы добавить пользовательский пресет в хук Header, выполните следующее:</p>
        <ul class="marked-list">
            <li>Откройте файл <strong>/themes/your_theme/header.tpl</strong> для редактирования.</li>
            <li>Найдите следующий фрагмент кода:
                <pre class="codebox">
...
<ul class="index-list">
    ...
    <li>'Product Footer' соответствует стандартному хуку displayFooterProduct, который отображается в футере страницы
        товара.
    </li>
</ul>

<h4>Основная панель TM Mega Layout</h4>
<h4 class="text-secondary">Основные макеты</h4>
...
<ul class="index-list">
    ...
    <li>
        <p>Затем заполните поле 'Введите название макета' в всплывающем окне, введя туда новое название пресета (2) и
            нажмите на кнопку 'Сохранить' (3).</p>
        <figure class="img-polaroid"><img src="img/tmmegalayout100-add-preset-2.png" alt=""/></figure>
    </li>
    <li>
        <p>Пресет успешно создан, теперь он отображается в списке доступных пресетов (4). Созданный пресет доступен для
            редактирования (5).</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Пресет активирован. Если Вам нужно отобразить этот пресет только на некоторых страницах, откройте выпадающий
            список (3) и выберите нужные страницы. Чтобы применить изменения, нажмите вне области списка. Пресет,
            отображаемый на всех страницах, будет отмечен заполненной звездочкой в списке пресетов, а тот, который
            отображается только на некоторых страницах, будет отмечен частично заполненной звездочкой.</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Вы увидите всплывающее окно, заполните поле 'Ввести классы обертки' (2) и нажмите на кнопку 'Подтвердить'
            (3).</p>
...
<p class="alert alert-warning">
    <span>Удаление элемента пресета приведёт к удалению всех его дочерних элементов и стилей.</span>
</p>
<ul class="index-list">
    <li>
...
<ul class="index-list">
    <li>
        <p>Для того чтобы добавить пользовательские стили для обложки, нажмите на значок "Карандаш" (1) в блоке
            обертки.</p>
        <figure class="img-polaroid"><img src="img/tmmegalayout100-wrapper-add-styles-1.png" alt=""></figure>
    </li>
    <li>
        <p>В всплывающем окне заполните все нужные поля (ознакомьтесь с разделом 'Стили' руководства), и нажмите на
            кнопку 'Сохранить' (2).</p>
...
<ul class="index-list">
    <li>
        <p>Для того чтобы вставить новый блок, нажмите на '+ Добавить ряд' (1) в блоке обложки, или '+ Добавить ряд' (2)
            в основном блоке пресета, или '+ Добавить ряд' (3) в выпадающем списке колонок.</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Вы увидите всплывающее окно, заполните все необходимые поля в этом окне (ознакомьтесь с разделом 'Стили'
            руководства) и нажмите на кнопку 'Сохранить' (3).</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Заполните поля (классы Bootstrap col-xs*, col-sm*, col-md*, col-lg) в всплывающем окне и нажмите на кнопку
            'Подтвердить' (3).</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Заполните поля (col-xs*, col-sm*, col-md*, col-lg – классы bootstrap) в всплывающем окне и нажмите на кнопку
            'Подтвердить' (3).</p>
...
<p class="box-notification"><span> Будьте внимательны при добавлении модулей в пресет, некоторые из модулей желательно использовать, если они не меняют видимый макет, например модуль статистики 'Data mining for statistics'.</span>
</p>
<ul class="index-list">
    <li>
    ...
    <li>
        <p>Если нужно, введите пользовательский класс (3) в всплывающем окне и выберите модуль (4), затем нажмите на
            кнопку 'Подтвердить' (5).</p>
...
<ul class="index-list">
    <li>
        <p>Для того чтобы указать пользовательский класс модуля, откройте меню в блоке модуля (значок 'многоточие')
            (1).</p>
...
<p>Блоки логотипа и сообщения об авторских правах редактируются так же, как и модули, за исключением того факта, что
    логотип может быть помещен только в верхний или нижний колонтитул, а блок сообщения об авторских правах может быть
    размещен только в позиции Footer.</p>

<h4 class="text-secondary">Страница товара</h4>
<h5>Вкладка информации о товаре</h5>
<h6>При помощи этой вкладки Вы можете переключать макеты страницы товара. Она отобразится в админ панели после того как
    Вы выполните простые действия, описанные ниже.</h6>
<h5>Создание макета</h5>
<h6>Макеты создаются и изменяются вручную.</h6>
<ul class="index-list">
    <li><p>Создайте папку 'product_pages' в папке вашего шаблона.</p>
        <figure class="img-polaroid"><img src="img/tmmegalayout110-product-info-3.png" alt=""></figure>
    </li>
    <li>В папке шаблона найдите файл 'product.tpl', скопируйте его в созданную папку 'product_pages' и переименуйте на
        'default.tpl'. Для того чтобы создать несколько макетов - дублируйте этот файл, переименуйте его (e.g.
        'layout_1.tpl', 'layout_2.tpl') и измените структуру в соответствии с вашими потребностями.
    </li>
    <li>Создайте файл 'config.json' в этой папке. Скопируйте в него следующий фрагмент кода:
        <pre class="codebox">
{
  "default": {
    "name": "Default",
    ...
    "default": 1
        ...
        <ul class="marked-list">
            <li><strong>"default"</strong> - название файла.tpl, который содержит структуру страницы товара.</li>
            <li>"name": <strong>"Default"</strong> - название макета страницы товара в настройках модуля.
            </li>
            <li>"preview": <strong>"default.jpg"</strong> - картинка предварительного просмотра макета страницы товара в
                настройках модуля; изображение должно быть размещено в папке 'product_pages'.
            </li>
            <li><p>"default": <strong>1</strong> - задайте значение '1', если макет должен использоваться как макет по
                    умолчанию</p><br>
                <p class="alert small alert-warning">Один из макетов должен содержать значение '1', для того чтобы
                    использоваться как макет по умолчанию.</p>
            </li>
        </ul>
        <p>Этот код нужно дублировать для каждого созданного макета. Он должен содержать соответствующие значения.
            Например:</p>
        <pre class="codebox">
{
  "default": {
  ...
  "layout_2": {
    ...
    <li>Откройте файл 'product.tpl' в папке шаблона. Удалите всё и вставьте следующий код:
        <pre class="codebox">
...
{/if}</pre>
    ...
    <li>Для того чтобы добавить/изменить стили любого макета страницы товара, перейдите в папку your_theme_folder/css/ и
        добавьте новую папку 'product_pages'. В этой папке создайте файл с названием макета и расширением .css
        (например, 'default.css', 'layout_1.css', 'layout_2.css'). Эти файлы должны содержать стили соответствующего
        макета страницы товара.
    </li>
    <li>Для того чтобы добавить скрипты к любому макету страницы товара, перейдите в папку your_theme_folder/js/ и
        добавьте новую папку 'product_pages'. В этой папке создайте файл с названием макета и расширением .js (например,
        'default.js', 'layout_1.js', 'layout_2.js'). Эти файлы должны содержать скрипты соответствующего макета страницы
        товара.
    </li>
</ul>
<h5>Переключение между макетами</h5>
<p>Выберите 'Страница товара' из выпадающего списка (1) и нажмите на вкладку 'Информация о товаре' (2).</p>
<figure class="img-polaroid"><img src="img/tmmegalayout110-product-info-1.png" alt=""></figure>
<p>В этой вкладке Вы можете переключить макет страницы товара. Изображение макета с серой границей задано как
    стандартное.</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Для того чтобы предварительно просмотреть пресет нажмите на кнопку 'Предварительный просмотр макета' (3)
            рядом с нужным макетом, для того чтобы выполнить экспорт, нажмите на кнопку 'Экспортировать макет' (4).</p>
...
<ul class="index-list">
    <li>
        <p>Для того чтобы импортировать пресет, откройте вкладку <strong>Инструменты (1)</strong> и выберите <strong>'Импорт'
                (2)</strong>.</p>
        <figure class="img-polaroid"><img src="img/tmmegalayout100-import-preset-1.png" alt=""/></figure>
    </li>
    <li>
        <p>Затем нажмите на кнопку <strong>Добавить файл (3)</strong> и выберите zip файл вашего экспортированного
            пресета. Если файл архива является экспортированным пресетом, Вы увидите предварительный просмотр пресета.
        </p>
        <figure class="img-polaroid"><img src="img/tmmegalayout100-import-preset-2.png" alt=""/></figure>
    </li>
    <li>
        <p>Если пресет соответствует вашим потребностям, нажмите на кнопку <strong>'Импорт' (4)</strong> (Import). Будет
            выполнен импорт пресета и пресет будет добавлен в список доступных пресетов.</p>
        <figure class="img-polaroid"><img src="img/tmmegalayout100-import-preset-3.png" alt=""/></figure>
    </li>
</ul>

<h5>Сброс</h5>
<p>Сброс сбрасывает все пресеты до начального состояния (как они были предоставлены с шаблоном), все пресеты, созданные
    пользователем, будут удалены.</p>
...
<ul class="index-list">
    <li>
        <p>Для того чтобы сбросить пресеты, перейдите на вкладку 'Инструменты' (1). В открывшемся блоке откройте вкладку
            'Настройки' (2).</p>
...
<p>Оптимизация скриптов и стилей добавляет исключения для модулей в разделе Header, на основании их использования в
    пресетах. Это позволяет ускорить скорость загрузки страницы. Оптимизация работает в текстовом режиме.</p>
<p>Включение оптимизации:</p>
<ul class="index-list">
    <li>
        <p>Для того чтобы включить оптимизацию, откройте вкладку 'Инструменты' (1) и выберите вкладку 'Настройки'
            (2).</p>
...
<p>Если оптимизация включена при редактировании и включении пресетов, оптимизация будет отброшена, но Вы увидите окно,
    предлагающее выполнить оптимизацию. Нет необходимости оптимизировать скрипты и стили каждый раз, когда Вы вносите
    изменения в пресеты. Выполнять отптимизацию лучше, когда Вы закончите редактирование.</p>
...
<ul class="index-list">
    <li>
        ...
        <ul class="marked-list">
            <li>background-image (фоновое изображение) – значением является ссылка на изображение. Используется
                изображение из папки ~/images/cms/.
            </li>
            <li>background-color (цвет фона) – значение можно задать в любом формате цвета (rgb, hex и т.д). Вы можете
                выбрать цвет используя инструмент colorpicker.
            </li>
            ...
            <li>background-origin (область размещения пользовательского изображения) - все доступные настройки
                перечислены в виде выпадающего списка.
            </li>
            </li>
        </ul>
    </li>
    <li><p>Стили границы.</p>
        ...
        <ul class="marked-list">
            <li>border-top-style, border-right-style, border-left-style, border-bottom-style - все доступные настройки
                перечислены в виде выпадающего списка.
            </li>
            <li>border-top-width, border-right-width, border-left-width, border-bottom-width – задайте значение в
                пикселях.
            </li>
            <li>border-top-right-radius, border-top-left-radius, border-bottom-right-radius, border-bottom-left-radius -
                задайте значение в пикселях.
            </li>
            <li>border-top-сolor, border-right-color, border-left-color, border-bottom-color – задайте значение в любом
                формате цвета (rgb, hex и т.д.) Вы можете выбрать цвет, используя инструмент colorpicker.
            </li>
        </ul>
    </li>
    <li><p>Другие стили.</p>
...
<p>Если Вы удалите или отключите модуль 'TM Mega Layout', все активные пресеты будут отключены, и Вы увидите позиции
    (хуки) в их изначальном виде.</p>