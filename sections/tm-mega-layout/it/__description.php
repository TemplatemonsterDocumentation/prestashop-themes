...
<?php if ($project == 'impresta') { ?>
    ...
    <!--    </div>-->
<?php } ?>
<p>Questo modulo è progettato per consentire la creazione di layout personalizzati (preset) per i ganci e la
    visualizzazione sul sito anziché
...
<ul class="index-list">
    ...
    <li>
        ...
        <ul class="marked-list">
            ...
            <li><p>La posizione del modulo in 'Moduli e servizi -> Posizioni' non influisce sulla preimpostazione.</p>
            </li>
...
<h6>Il modulo fornisce un'opzione per modificare la posizione del modulo e impostare la griglia per 3 ganci:
    ...
    Non influenzerà la posizione dei moduli nel predefinito. Nel caso in cui il modulo non sia stato aggiunto al gancio,
    non è possibile
    Essere aggiunto al preset.</h6>

<h4>Integrare il modulo sul tema</h4>
<p class="alert alert-warning">
    <span>Senza questo passaggio i vostri preset non verranno visualizzati sul frontend.</span></p>
<ul class="index-list">
    <li><p>Colonna superiore. Per aggiungere il preimpostazione personalizzata al gancio topColumn, è necessario
            eseguire le seguenti operazioni:</p>
        <ul class="marked-list">
...
{/if}</pre>
    ...
    <li><p>Casa. Per aggiungere il preimpostazione personalizzata all'home Home, è necessario eseguire le seguenti
            operazioni:</p>
        <ul class="marked-list">
...
{/if}</pre>
    ...
    <li><p>Piè di pagina. Per aggiungere il predefinito personalizzato al gancio Footer, è necessario eseguire le
...
{/if}</pre>
    ...
    <li><p>Intestazione. Per aggiungere il predefinito personalizzato al gancio Header, è necessario eseguire le
            seguenti operazioni:</p>
        <ul class="marked-list">
            <li>Apri il<strong>/themes/your_theme/header.tpl</strong> file per la modifica.</li>
            <li>Individuare il seguente codice:
...
{/if}</pre>
    ...
    <li><p>Piè di pagina del prodotto. Per aggiungere il predefinito personalizzato al gancio del piè di pagina del
            prodotto, è necessario eseguire quanto segue
            Passi:</p>
        <ul class="marked-list">
...
<ul class="index-list">
    ...
    <li>'Prodotto Footer' corrisponde all'originale hook DisplayFooterProduct, che viene visualizzato nella pagina del
        prodotto Footer.
    </li>
</ul>
...
<p>Il pannello di configurazione del modulo TM Mega Layout principale che consente di aggiungere un preimpostazione al
    gancio richiesto e configurarlo
    il preset.</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Successivamente, compilare il campo 'Inserisci nome layout' nella finestra popup digitando il nuovo titolo
            preimpostato (2) e premere
            'Salva' (3).</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Il preimpostazione è stato attivato. Se è necessario visualizzare questo predefinito solo su alcune pagine,
            aprire il menu a discesa (3) e
            Selezionare le pagine necessarie. Per applicare le modifiche, fare clic fuori dall'area di elenco. Un preset
            che viene visualizzato su tutti
            Le pagine verranno contrassegnate con una stella riempita nell'elenco delle preselezioni e quella
            visualizzata solo su alcuni
...
<p>L'aggiunta della classe personalizzata ti consente di creare uno stile specifico per il tuo wrapper utilizzando le
    regole CSS.</p>
<ul class="index-list">
    <li>
    ...
    <li>
        <p>Verrà visualizzata una finestra pop-up, compilare il campo 'Inserisci classi di wrapper' (2) e premi
            'Conferma' (3)
            pulsante.</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Nella seguente finestra popup compilare tutti i campi necessari (si può fare riferimento alla documentazione
            'Styling'
...
<ul class="index-list">
    <li>
        <p>Per inserire una nuova riga, premere '+ Aggiungi riga' (1) nel blocco wrapper o '+ Aggiungi riga' (2) nella
            finestra principale
...
<p>L'aggiunta di classi personalizzate consente di creare uno stile di righe personalizzato utilizzando le regole
    CSS.</p>
<ul class="index-list">
    <li>
...
<p class="alert alert-warning">
    <span>La rimozione dell'elemento preimpostato causerà anche la rimozione dei suoi articoli per bambini e dei loro stili.</span>
</p>
<ul class="index-list">
    <li>
...
<ul class="index-list">
    ...
    <li>
        <p>Verrà visualizzata la finestra pop-up, compilare tutti i campi necessari (si può fare riferimento alla
            documentazione
...
<ul class="index-list">
    ...
    <li>
        <p>Compilare i campi (col-xs *, col-sm *, col-md *, col-lg - classi di bootstrap) nella finestra pop-up e
            premere
            'Conferma' (3).</p>
...
<p class="alert alert-warning">
    <span>La rimozione dell'elemento predefinito causerà anche la cancellazione dei suoi elementi figlio e dei loro stili.</span>
</p>
<ul class="index-list">
    <li>
...
<ul class="index-list">
    <li>
        <p>Per aggiungere il modulo alla preimpostazione in un blocco di colonna, aprire il menu (l'icona 'ellissi')
            (1).</p>
    ...
    <li>
        <p>Se necessario, è possibile immettere la classe personalizzata (3) nella finestra pop-up e selezionare il
            modulo (4), premere successivamente
            'Conferma' (5).</p>
...
<p>I blocchi Logo e Copyright vengono modificati allo stesso modo dei moduli, fatta eccezione per il fatto che Logo può
    essere inserito solo in
    La posizione di intestazione o piè di pagina e il blocco Copyright possono essere collocati solo nella posizione
    Footer.</p>

<h4 class="text-secondary">Prodotto Pagina</h4>
<h5>Scheda Product Info</h5>
<h6>Con questa scheda puoi cambiare i layout della pagina dei prodotti. Apparirà nel pannello di amministrazione dopo
    aver eseguito alcune azioni semplici descritte di seguito.</h6>
...
<ul class="index-list">
    ...
    <li>Nella cartella tema trovi il file 'product.tpl', copialo nella cartella creata 'product_pages' e rinomina
        'default.tpl'. Per creare più layout - duplicare questo file, rinominarlo (ad esempio, "layout_1.tpl",
        "layout_2.tpl") e modificare la struttura in base alle proprie esigenze.
    </li>
  ...
  "default": {
    ...
    "default": 1
        ...
        <ul class="marked-list">
            ...
            <li>"nome": <strong>"Default"</strong> - titolo del layout della pagina di prodotto nelle impostazioni del
                modulo.
            </li>
            <li>"preview": <strong>"default.jpg"</strong> - anteprima del layout della pagina di prodotto nelle
                impostazioni del modulo; L'immagine dovrebbe trovarsi nella cartella 'product_pages'.
            </li>
            <li><p>"default": <strong>1</strong> - impostare su '1' se il layout deve essere impostato come predefinito
                </p><br>
                <p class="alert small alert-warning">uno dei layout dovrebbe contenere il valore '1' da impostare come
                    impostazione predefinita.</p>
            </li>
        </ul>
        <p>Questo codice dovrebbe essere duplicato per ogni layout creato e contenere i valori corrispondenti. Per
            esempio:</p>
        <pre class="codebox">
{
  "default": {
...
{/if}</pre>
    ...
    <li>Per aggiungere/modificare gli stili di qualsiasi layout di una pagina di prodotto, accedi a
        your_theme_folder/css/e aggiungi la nuova cartella 'product_pages'. In questa cartella crea il file con il nome
        del layout e l'estensione .css (ad esempio, "default.css", "layout_1.css", "layout_2.css"). Questi file devono
        contenere stili del layout della pagina di prodotto corrispondente.
    </li>
    <li>Per aggiungere script a qualsiasi layout di pagina di prodotti, andare a your_theme_folder/js/e aggiungere una
        nuova cartella 'product_pages'. In questa cartella crea un file con il nome del layout e l'estensione .js (ad
        esempio, "default.js", "layout_1.js", "layout_2.js"). Questi file devono contenere gli script del relativo
        layout di pagina di prodotto.
    </li>
</ul>
...
<p>In questa scheda è possibile cambiare i layout della pagina dei prodotti. L'immagine di layout con il bordo grigio è
    impostata come impostazione predefinita.</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Per visualizzare in anteprima la preimpostazione, premere il pulsante "Anteprima layout" (3) accanto al
            preimpostazione necessario, al fine di
...
<ul class="index-list">
    <li>
        <p>Per importare il preimpostato, è necessario aprire il file <strong>Strumenti (1)</strong> tab e scegliere
            <strong>'Importa'
                (2)</strong>.</p>
        <figure class="img-polaroid"><img src="img/tmmegalayout100-import-preset-1.png" alt=""/></figure>
    </li>
    <li>
        <p>Avanti, premi il tasto <strong>Aggiungi file (3)</strong> E seleziona il file zip del predefinito esportato.
            Nel caso
    ...
    <li>
        <p>Se questo preset soddisfa le tue esigenze, premere <strong>'Importa' (4)</strong>. Il preset verrà importato
            e aggiunto
...
<ul class="index-list">
    <li>
        <p>Per ripristinare i preset, passare alla scheda "Strumenti" (1). Nel blocco apparso aprire la scheda "Opzioni"
            (2).</p>
...
<p>L'ottimizzazione degli stili e degli script aggiunge esclusioni per i moduli nella sezione Intestazione, in base al
    loro utilizzo nei preset. Questo
...
<p>Se l'ottimizzazione è attivata quando si modifica ed abilita i preset, l'ottimizzazione viene eliminata, ma vedrai
    una finestra
    offrendo di eseguire l'ottimizzazione. Non è necessario ottimizzare gli script e gli stili ogni volta che si
    cambiano i preset. Suo
...
<ul class="index-list">
    <li>
        ...
        <ul class="marked-list">
            <li>Background-image (immagine di sfondo) - l'URL dell'immagine o il valore "none". L'immagine viene
                selezionata dal file
                ~ /images/cms/cartella.
            </li>
            <li>background-color (colore di sfondo) - il valore può essere impostato in qualsiasi formato di colore
                (rgb, hex, ecc.). Puoi
                Scegli il colore usando lo strumento colorpicker.
            </li>
            <li>ripetizione di sfondo (ripetizione di sfondo) - tutte le opzioni disponibili sono elencate nei pulsanti
                di scelta rapida.
            </li>
            <li>posizione di sfondo (posizione di sfondo) - tutte le opzioni disponibili sono elencate nell'elenco a
                discesa.
            </li>
            <li>dimensione di sfondo (dimensione di sfondo) - tutte le opzioni disponibili sono elencate nell'elenco a
                discesa.
            </li>
            <li>background-origine (regione di posizionamento dell'immagine di sfondo) - tutte le opzioni disponibili
                sono elencate nella finestra di dialogo
                cadere in picchiata.
            </li>
        </ul>
    </li>
    <li><p>Bordo stili.</p>
        ...
        <ul class="marked-list">
            ...
            <li>bordo-larghezza-larghezza, bordo-destra-larghezza, bordo-sinistra-larghezza, bordo-fondo-larghezza
                (larghezza bordi) - dovrebbe essere
                Impostato in pixel.
            </li>
            <li>border-top-сolor, border-right-color, border-left-color, border-bottom-color (colore dei bordi) - il
                valore
                può essere impostato in qualsiasi formato di colore (rgb, hex, ecc.). È possibile scegliere il colore
                utilizzando lo strumento di coloratore.
            </li>
            <li>il raggio del bordo superiore-destro, il raggio di bordo superiore-sinistro, il bordo inferiore-destro
                destro, il raggio di fondo-basso-sinistra
...
<h5>Avvertenze</h5>
<p>Se il seguente messaggio viene visualizzato nel blocco di elementi del modulo, è necessario abilitare il modulo di
    cui sopra.</p>
<figure class="img-polaroid"><img src="img/tmmegalayout100-module-warning-1.png" alt=""></figure>
<p>Se nel blocco di elementi del modulo viene visualizzato il seguente messaggio, è necessario installare il modulo di
    cui sopra.</p>
