...
<p>Este módulo está diseñado para permitir la creación de diseños personalizados (presets) para ganchos y mostrarlos en
    el sitio en lugar de
         las posiciones predeterminadas. Esta ventaja del módulo le permite crear diferentes marcas de gancho y
    modificarlas hasta
         tus necesidades.</p>
...
<ul class="index-list">
    ...
    <li>
        ...
        <ul class="marked-list">
            ...
            <li><p>La posición del módulo en la sección 'Módulos y servicios -> Posiciones' no afecta al valor
                    preestablecido.</p></li>
...
<h6>Módulo le ofrece una opción para cambiar la posición del módulo y configurar la cuadrícula para 3 ganchos:
    displayTopColumn, displayHome, displayFooter. Cambiar la posición de los módulos en la sección 'Módulos y servicios
    -> Posiciones'
...
<ul class="index-list">
    <li><p>Columna superior. Para agregar presets personalizados al gancho topColumn, debe realizar los siguientes
            pasos:</p>
        <ul class="marked-list">
...
{/if}</pre>
    ...
    <li><p>Pie de página. Para agregar presets personalizados al gancho de pie de página, debe realizar los siguientes
            pasos:</p>
        <ul class="marked-list">
...
{/if}</pre>
    ...
    <li><p>Encabezamiento. Para agregar presets personalizados al gancho de encabezado, debe realizar los siguientes
            pasos:</p>
        <ul class="marked-list">
            <li>Abra el archivo <strong>/themes/your_theme/header.tpl</strong> para editar.</li>
            <li>Busque el código siguiente:
...
{/if}</pre>
    ...
    <li><p>Pie de producto. Para agregar presets personalizados al gancho del pie de producto, debe realizar los
            siguientes
            pasos:</p>
        <ul class="marked-list">
...
<ul class="index-list">
    ...
    <li>'Top Column' corresponde al gancho original de displayTopColumn. Este gancho viene justo después de que el
        gancho de cabecera.
    </li>
...
<p>El panel principal de configuración del módulo TM Mega Layout que le permite agregar un preset al gancho requerido y
    configurar
    el preset.</p>
...
<ul class="index-list">
    ...
    <li>
        <p>A continuación, rellene el campo 'Introduzca el nombre del diseño' en la ventana emergente escribiendo el
            nuevo título preestablecido (2) allí y presione
            'Guardar' (3).</p>
        <figure class="img-polaroid"><img src="img/tmmegalayout100-add-preset-2.png" alt=""/></figure>
    </li>
    <li>
        <p>El preset se creó correctamente, ya está listado entre los presets disponibles (4). Se ha seleccionado el
...
<ul class="index-list">
    ...
    <li>
        <p>El preset se ha activado. Si necesita mostrar este preset solamente en algunas páginas, abra el menú
            desplegable (3) y
            seleccione las páginas que necesita. Para aplicar los cambios, haga clic fuera del área de la lista. Un
            preset que se muestra en todas
...
<ul class="index-list">
    ...
    <li>
        <p>Especifique el nuevo título preestablecido (3) en una ventana emergente y presione 'Cambiar el nombre del
            diseño' (4).</p>
...
<ul class="index-list">
    <li>
        <p>Para agregar estilos personalizados al contenedor, presione el icono 'lápiz' (1) en el bloque de
            contenedor.</p>
        <figure class="img-polaroid"><img src="img/tmmegalayout100-wrapper-add-styles-1.png" alt=""></figure>
    </li>
    <li>
        <p>En la ventana emergente siguiente rellene todos los campos necesarios (consulte la sección 'Styling' de la
            documentación) y pulse el botón 'Guardar' (2).</p>
...
<ul class="index-list">
    <li>
        <p>Para insertar una nueva fila, pulse '+ Añadir fila' (1) en el bloque de contenedor o '+ Añadir fila' (2) en
            el bloque de preselección principal o
...
<p class="alert alert-warning">
    <span>La eliminación del elemento preestablecido también provocará la eliminación de sus elementos secundarios y sus estilos.</span>
</p>
<ul class="index-list">
    <li>
...
<h4>Columna</h4>
<p>Se trata de un elemento con ancho de bloque configurable para diferentes dimensiones, basado en la cuadrícula
    Bootstrap.</p>
...
<p class="alert alert-warning">
    <span>La eliminación de elementos predefinidos también hará que sus elementos secundarios y sus estilos eliminen.</span>
</p>
<ul class="index-list">
    <li>
...
<ul class="index-list">
    <li>
        <p>Para añadir estilos de columnas, abra el menú (el icono de puntos suspensivos) (1) en un bloque de
            columnas.</p>
...
<ul class="index-list">
    <li>
        <p>Para añadir el módulo al preset en un bloque de columnas, abra el menú (el icono 'puntos suspensivos')
            (1).</p>
    ...
    <li>
        <p>Si es necesario, puede ingresar la clase personalizada (3) en la ventana emergente y seleccionar el módulo
            (4), luego presione
                         'Confirmar' (5).</p>
...
<ul class="index-list">
    <li>
        <p>Para especificar una clase personalizada para el módulo, abra el menú en el bloque de módulos (el icono de
            'puntos suspensivos')
            (1).</p>
...
<p>Los bloques de Logo y de Copyright se editan de la misma manera que los módulos, excepto por el hecho de que el
    logotipo sólo se puede colocar en la posición
...
<h6>Mediante esta pestaña puede cambiar los diseños de la página del producto. Aparecerá en el panel de administración
    después de realizar algunas acciones sencillas descritas a continuación.</h6>
...
<ul class="index-list">
    ...
    <li>En la carpeta del tema, busque el archivo 'product.tpl', cópielo en la carpeta creada 'product_pages' y cambie
        el nombre a 'default.tpl'. Para crear varios diseños - duplique este archivo, cambie su nombre (por ejemplo,
        'layout_1.tpl', 'layout_2.tpl') y cambie la estructura según sus necesidades.
    </li>
        ...
        <pre class="codebox">
{
  "default": {
    ...
    "default": 1
        ...
        <ul class="marked-list">
            <li><strong>"default"</strong> - nombre del archivo .tpl que contiene la estructura de la página del
                producto.
            </li>
            <li>"name": <strong>"Default"</strong> - título del diseño de la página del producto en la configuración del
                módulo.
            </li>
            <li>"preview": <strong>"default.jpg"</strong> - vista previa del diseño de la página del producto en la
                configuración del módulo; La imagen debe ubicarse en la carpeta 'product_pages'.
            </li>
            <li><p>"default": <strong>1</strong> - establecida en '1' si el diseño debe configurarse como predeterminado
                </p><br>
                <p class="alert small alert-warning">Uno de los diseños debe contener el valor '1' que se debe
                    establecer como valor predeterminado.</p>
            </li>
        </ul>
...
{/if}</pre>
    ...
    <li>Para añadir/editar estilos de cualquier diseño de página de producto, vaya a your_theme_folder/css/ y agregue
        una nueva carpeta 'product_pages'. En esta carpeta, cree un archivo con el nombre de diseño y la extensión .css
        (por ejemplo, 'default.css', 'layout_1.css', 'layout_2.css'). Estos archivos deben contener estilos del diseño
        de la página del producto correspondiente.
    </li>
    <li>Para agregar scripts a cualquier diseño de página de producto, vaya a your_theme_folder/js/ y añada una nueva
        carpeta 'product_pages'. En esta carpeta, cree un archivo con el nombre de diseño y la extensión .js (por
        ejemplo, 'default.js', 'layout_1.js', 'layout_2.js'). Estos archivos deben contener scripts del diseño de la
...
<p>En esta pestaña puede cambiar los diseños de la página del producto. La imagen de diseño con el borde gris se
    establece como predeterminado.</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Para previsualizar el preset, presione el botón 'Layout preview' (3) al lado del preset que usted necesita,
            para
...
<ul class="index-list">
    ...
    <li>
        <p>A continuación, presione el botón <strong>Agregar archivo (3)</strong> Y seleccione el archivo zip de su
            preset exportado. En caso
    ...
    <li>
        <p>Si este preset satisface sus necesidades, presione el botón <strong>'Importar' (4)</strong>. El preset se
            importará y se agregará
...
<h5>Reiniciar</h5>
<p>'Restablecer' vuelve todos los presets al estado inicial (a la manera en que vinieron con la plantilla), y descarta
    todos los presets creados.</p>
...
<ul class="index-list">
    <li>
        <p>Para restablecer los presets, vaya a la pestaña 'Herramientas' (1). En el bloque aparecido, abra la pestaña
            'Opciones' (2).</p>
...
<p>La optimización de estilos y secuencias agrega exclusiones para los módulos en la sección Encabezado, en función de
    su uso en preajustes. Esto
...
<ul class="index-list">
    <li>
        <p>Para habilitar la optimización, abra la pestaña 'Herramientas' (1) y seleccione la pestaña 'Opciones'
            (2).</p>
...
<p>Si la optimización está habilitada al editar y habilitar presets, la optimización se descarta, pero verá una ventana
    que ofrece ejecutar la optimización. No hay necesidad de optimizar los scripts y los estilos cada vez que cambie
    presets.
...
<ul class="index-list">
    <li>
        ...
        <ul class="marked-list">
            ...
            <li>background-color (color de fondo) - el valor se puede establecer en cualquier formato de color (rgb,
                hex, etc.). Usted puede
                                 elijir el color con la herramienta colorpicker.
            </li>
            <li>background-repeat (repetición de fondo) - todas las opciones disponibles se enumeran en los botones de
                radio.
            </li>
            <li>background-position (posición de fondo) - todas las opciones disponibles se muestran en la lista
                desplegable.
            </li>
            <li>background-size (tamaño de fondo) - todas las opciones disponibles se muestran en la lista
                desplegable.
            </li>
            <li>background-origin (región de posicionamiento de imagen de fondo) - Todas las opciones disponibles se
                muestran en
    ...
    <li><p>Estilos de borde.</p>
        ...
        <ul class="marked-list">
            ...
            <li>border-top-width, border-right-width, border-left-width, border-bottom-width (borders width) - debe
                establecerse
                en píxeles.
            </li>
            <li>border-top-сolor, border-right-color, border-left-color, border-bottom-color (borders color) - el valor
                se puede establecer en cualquier formato de color (rgb, hex, etc.). Puede elegir el color con la
                herramienta colorpicker.
            </li>
