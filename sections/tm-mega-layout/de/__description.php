...
<p>Mit diesem Modul können Sie benutzerdefinierte Layouts (Voreinstellungen) für Hooks erstellen und sie anstatt der
    Positionen auf der Website darstellen. Dadurch können Sie verschiedene Layouts erstellen und sie nach Ihren
    Bedürfnissen bearbeiten.</p>
...
<ul class="index-list">
    ...
    <li>
        ...
        <ul class="marked-list">
            ...
            <li><p>Die Position des Moduls im Bereich 'Module und Services -> Positionen' wirkt nicht auf die
                    Voreinstellung.</p></li>
            <li><p>Das Modul ermöglicht es Ihnen nicht, verschiedene Modul einzustellen. Sie können nicht verschiedene
                    Modul-Einstellungen für verschiedene Voreinstellungen festlegen.</p></li>
        </ul>
    </li>
</ul>
<h6>Dieses Modul ermöglicht es Ihnen, die Position des Moduls zu ändern und das Grid für 3 Hooks einzustellen:
    displayTopColumn, displayHome, displayFooter. Wenn Sie Positionen der Module in dem Bereich 'Module und Services ->
    Positionen' ändern, werden die Positionen der Module in der Voreinstellung nicht geändert. Wenn das Modul zum Hook
    nicht hinzugefügt ist, kann es nicht zur Voreinstellung hinzugefügt werden.</h6>

<h4>Wie man das Modul in die Vorlage integriert</h4>
<p class="alert alert-warning">Wenn Sie diese Aktion nicht durchführen, werden Voreinstellungen auf Ihrer Website nicht
    dargestellt.</p>
<ul class="index-list">
    <li><p>Die obere Spalte. Um eine benutzerdefinierte Voreinstellung zum Hook topColumn hinzuzufügen, führen Sie die
            folgende Aktion durch:</p>
        <ul class="marked-list">
...
{/if}</pre>
    ...
    <li><p>Home. Um eine benutzerdefinierte Voreinstellung zum Hook "Home" hinzuzufügen, nehmen Sie die folgenden
            Änderungen vor:</p>
        <ul class="marked-list">
...
{/if}</pre>
    ...
    <li><p>Footer. Um eine benutzerdefinierte Voreinstellung zum Hook "Footer" hinzuzufügen, nehmen Sie die folgenden
            Änderungen vor:</p>
        <ul class="marked-list">
...
{/if}</pre>
    ...
    <li><p>Header. Um eine benutzerdefinierte Voreinstellung zum Hook "Header" hinzuzufügen, nehmen Sie die folgenden
            Änderungen vor:</p>
        <ul class="marked-list">
            <li>Öffnen Sie die Datei <strong>/themes/your_theme/header.tpl</strong> zur Bearbeitung.</li>
            <li>Finden Sie die folgende Codezeile:
...
{/if}</pre>
    ...
    <li><p>Footer des Produktes. Um eine benutzerdefinierte Voreinstellung zum Hook Product footer hinzuzufügen, nehmen
            Sie die folgenden Änderungen vor:</p>
        <ul class="marked-list">
...
<ul class="index-list">
    <li>Hook 'Header' verbindet 2 Standard-Hooks: displayNav und displayTop. Dieses Hook entspricht dem Header der
        Website.
    </li>
    <li>'Top Column' entspricht dem Standard-Hook displayTopColumn. Dieses Hook befindet sich nach dem Hook Header.
    </li>
    <li>'Home' entspricht dem Standard-Hook displayHome.Dieses Hook befindet sich nur auf der Startseite der Website.
    </li>
    <li>'Footer' entspricht dem Standard-Hook displayFooter.</li>
    <li>'Product Footer' entspricht dem Standard-Hook displayFooterProduct, das im Footer auf der Produktseite
        dargestellt wird.
    </li>
</ul>
...
<p>Das Hauptpanel der Modul-Einstellungen TM Mega Layout ermöglicht es Ihnen, eine Voreinstellung zum notwendigen Hook
    hinzuzufügen und sie einzustellen.</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Danach füllen Sie das Feld 'Namen des Layouts eingeben' in dem DropDown Fenster aus, indem Sie einen neuen
            Namen der Voreinstellung (2) eingeben und drücken Sie auf den Button 'Speichern' (3).</p>
        <figure class="img-polaroid"><img src="img/tmmegalayout100-add-preset-2.png" alt=""/></figure>
    </li>
    <li>
        <p>Die Voreinstellung wurde erfolgreich erstellt, jetzt wird sie in der Liste der verfügbaren Voreinstellungen
            (4) dargestellt. Die erstellte Voreinstellung kann bearbeitet werden (5).</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Die Voreinstellung ist aktiviert. Wenn Sie diese Voreinstellung nur auf einigen Seiten darstellen möchten,
            öffnen Sie die DropDown Liste (3) und wählen Sie notwendige Seiten aus. Um die Änderungen anzuwenden,
            drücken Sie außer dem Listenbereich. Die Voreinstellung, die auf allen Seiten dargestellt wird, ist mit
            einem gefüllten Sternchen in der Liste der Voreinstellungen markiert. Die Voreinstellung, die nur auf
            einigen Seiten dargestellt wird, ist teilweise mit einem gefüllten Sternchen markiert.</p>
...
<p class="alert alert-warning"><span>Wenn Sie eine Voreinstellung löschen, können Sie sie nicht wiederherstellen.</span>
</p>
<ul class="index-list">
    <li>
...
<ul class="index-list">
    ...
    <li>
        <p>Geben Sie einen neuen Namen der Voreinstellung (3) in dem DropDown Fenster ein und drücken Sie auf den Button
            'Layout umbenennen' (4).</p>
...
<p>Indem Sie ine benutzerdefinierte CSS Klasse hinzufügen, können Sie bestimmte Stile für Ihre Verpackung mit Hilfe von
    CSS Regeln erstellen.</p>
<ul class="index-list">
    <li>
    ...
    <li>
        <p>Sie sehen das DropDown Fenster, füllen Sie das Feld 'Klasse der Verpackung eingeben' (2) aus und drücken Sie
            auf den Button 'Bestätigen' (3).</p>
...
<ul class="index-list">
    <li>
        <p>Um benutzerdefinierte Stile zur Verpackung hinzuzufügen, drücken Sie auf das Zeichen "Bleistift" (1) in dem
            Verpackungsblock.</p>
        <figure class="img-polaroid"><img src="img/tmmegalayout100-wrapper-add-styles-1.png" alt=""></figure>
    </li>
    <li>
        <p>In dem DropDown Fenster füllen Sie alle notwendigen Felder (machen Sie sich mit dem Bereich 'Stile' bekantt)
            aus und drücken Sie auf den Button 'Speichern' (2).</p>
...
<ul class="index-list">
    <li>
        <p>Um einen neuen Block einzufügen, drücken Sie '+ Reihe hinzufügen' (1) in dem Verpackungsblock oder '+ Reihe
            hinzufügen' (2) in dem Hauptblock der Voreinstellung oder '+ Reihe hinzufügen' (3) in der DropDown Liste der
            Spalten.</p>
...
<p>Wenn Sie eine benutzerdefinierte Klasse hinzufügen, können Sie benutzerdefinierte Stile der Reihe mit Hilfe von CSS
    Regeln erstellen.</p>
<ul class="index-list">
    <li>
    ...
    <li>
        <p>Füllen Sie das Feld 'Klassen der Reihe eingeben' (3) in dem DropDown Fenster aus und drücken Sie auf den
            Button 'Bestätigen' (4).</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Sie sehen das DropDown Fenster, füllen Sie alle notwendigen Felder in diesem Fenster (machen Sie sich mit dem
            Bereich 'Stile' bekannt) aus und drücken Sie auf den Button 'Speichern' (3).</p>
...
<h4>Spalte</h4>
<p>Es ist ein Element mit der eingestellten Breite des Blocks für verschiedene Bildschirmgrößen basierend auf dem Grid
    Bootstrap.</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Füllen Sie Felder (Klassen Bootstrap col-xs*, col-sm*, col-md*, col-lg) in dem DropDown Fenster aus und
            drücken Sie auf den Button 'Bestätigen' (3).</p>
...
<p class="alert alert-warning">
    <span>Wenn Sie das Element der Voreinstellung löschen, werden alle untergeordneten Elemente und Stile gelöscht.</span>
</p>
<ul class="index-list">
    <li>
...
<ul class="index-list">
    ...
    <li>
        <p>Füllen Sie Felder (col-xs*, col-sm*, col-md*, col-lg – Klassen bootstrap) in dem DropDown Fenster aus und
            drücken Sie auf den Button 'Bestätigen' (3).</p>
...
<ul class="index-list">
    <li>
        <p>Um Stile zur Spalte hinzuzufügen, öffnen Sie das Menü (das Zeichen 'drei Punkte') (1) in dem Block
            Spalten.</p>
    ...
    <li>
        <p> Sie sehen das DropDown Fenster füllen alle notwendigen Felder in diesem Fenster (machen Sie sich mit dem
            Bereich 'Stile' bekannt) aus und drücken Sie auf den Button 'Speichern' (3).</p>
...
<p class="box-notification"><span> Seien Sie vorsichtig, wenn Sie Module zu Voreinstellungen hinzufügen. Einige von ihnen lohnt es sich zu verwenden, wenn sie das sichtbare Layout (zum Beispiel, das Modul für die Statistik 'Data mining for statistics') nicht ändern.</span>
</p>
<ul class="index-list">
    <li>
        <p>Um ein Modul zur Voreinstellung in dem Block Spalten hinzuzufügen, öffnen Sie das Menü (das Zeichen 'drei
            Pinkte') (1).</p>
    ...
    <li>
        <p>Wenn es nötig ist, geben Sie eine benutzerdefinierte Klasse (3) in dem DropDown Fenster ein und wählen Sie
            das Modul (4), danach drücken Sie auf den Button 'Bestätigen' (5).</p>
...
<p>Indem Sie eine benutzerdefinierte Klasse hinzufügen, können Sie Stile des Moduls mit Hilfe von den CSS Regeln
    erstellen.</p>
<ul class="index-list">
    <li>
        <p>Um eine benutzerdefinierte Klasse für das Modul festzulegen, öffnen Sie das Menü im Block Modul (das Zeichen
            'drei Punkte') (1).</p>
    ...
    <li>
        <p>Legen Sie eine benutzerdefinierte Klasse (3) in dem DropDown Fenster fest und drücken Sie auf den Button
            'Bestätigen' (4).</p>
...
<p>Die Blöcke Logo und Urheberrechtserklärung können wie Module bearbeitet werden. Aber das Logo kann sowohl im Header
    als auch im Footer platziert werden und die Urheberrechtserklärung kann nur im Footer platziert werden.</p>

<h4 class="text-secondary">Produktseite</h4>
<h5>Der Tab Produktinformation</h5>
<h6>Mit Hilfe von diesem Tab können Sie Layouts der Produktseite umschalten. Sie wird in dem Control Panel dargestellt,
    nachdem die folgenden Aktionen durchführen.</h6>
...
<ul class="index-list">
    ...
    <li>In dem Ordner Ihrer Vorlage finden Sie die Datei 'product.tpl', kopieren Sie sie in den erstellten Ordner
        'product_pages' und bennenen Sie sie auf 'default.tpl' um. Um mehrere Layouts zu erstellen, duplizieren Sie
        diese Datei, bennenen Sie sie (e.g. 'layout_1.tpl', 'layout_2.tpl') um und ändern Sie die Struktur nach Ihren
        Bedürfnissen.
    </li>
  ...
  "default": {
    ...
    "default": 1
        ...
        <ul class="marked-list">
            ...
            <li>"preview": <strong>"default.jpg"</strong> - das Vorschaubild des Layouts der Produktseite in den
                Moduleinstellungen; das Bild muss in dem Ordner 'product_pages' platziert sein.
            </li>
            <li><p>"default": <strong>1</strong> - legen Sie den Wert '1' fest, wenn das Layout als Layout standardmäßig
                    verwendet werden muss</p><br>
                <p class="alert small alert-warning">Ein Layout muss den Wert '1' haben, um als Layout standardmäßig
                    verwenden zu können.</p>
            </li>
        </ul>
        <p>Dieser Code muss für jedes erstellte Layout dupliziert werden. Er muss entsprechende Werte haben. Zum
            Beispiel:</p>
        <pre class="codebox">
{
  "default": {
  ...
  "layout_2": {
    ...
    <li>Öffnen Sie die Datei 'product.tpl' in dem Ordner Ihrer Vorlage. Löschen Sie alles und fügen Sie den folgenden
        Code ein:
        <pre class="codebox">
...
{/if}</pre>
    ...
    <li>Um das Layout der Produktseite hinzuzufügen/zu ändern, öffnen Sie den Ordner your_theme_folder/css/ und fügen
        Sie den neuen Ordner 'product_pages' hinzu. In diesem Ordner erstellen Sie die Datei mit dem Namen des Layouts
        und der Erweiterung .css (zum Beispiel, 'default.css', 'layout_1.css', 'layout_2.css'). Diese Dateien müssen
        Stile des entsprechenden Layouts der Produktseite haben.
    </li>
    <li>Um Skripte zu jedem Layout der Produktseite hinzuzufügen, öffnen Sie den Ordner your_theme_folder/js/ und fügen
        Sie den neuen Ordner 'product_pages' hinzu. In diesem Ordner erstellen Sie die Datei mit dem Namen des Layouts
        und der Erweiterung .js (zum Beispiel, 'default.js', 'layout_1.js', 'layout_2.js'). Diese Dateien müssen Skripte
        des entsprechenden Layouts der Produktseite haben.
    </li>
</ul>
...
<p>In diesem Tab können Sie das Layout der Produktseite umschalten. Das Layout-Bild mit der grauen Grenze ist als
    Standardbild festgelegt.</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Um die Voreinstellung anzusehen, drücken Sie auf den Button 'Vorschau des Layouts' (3) neben dem notwendigen
            Layout. Um es zu exportieren, drücken Sie auf den Button 'Layout exportieren' (4).</p>
...
<ul class="index-list">
    <li>
        <p>Um eine Voreinstellung zu importieren, öffnen Sie den Tab <strong>Werkzeuge (1)</strong> und wählen Sie
            <strong>'Import' (2)</strong>.</p>
        <figure class="img-polaroid"><img src="img/tmmegalayout100-import-preset-1.png" alt=""/></figure>
    </li>
    <li>
        <p>Danach drücken Sie auf den Button <strong>Datei hinzufügen (3)</strong> und wählen Sie die zip Dateien Ihrer
            exportierten Voreinstellung. Wenn die Archivdatei die exportierte Voreinstellung ist, können Sie diese
            Voreinstellung ansehen.</p>
        <figure class="img-polaroid"><img src="img/tmmegalayout100-import-preset-2.png" alt=""/></figure>
    </li>
    <li>
        <p>Wenn die Voreinstellung Ihren Bedürfnissen entspricht, drücken Sie auf den Button <strong>'Import'
                (4)</strong> (Import). Die Voreinstellung wird importiert und zur Liste der verfügbaren Voreinstellungen
            hinzugefügt.</p>
...
<h5>Zurücksetzen</h5>
<p>Alle Voreinstellungen werden auf den Anfangszustand (wie sie am Anfang mit der Vorlage zur Verfügung gestellt wurden)
    zurückgesetzt. Alle Voreinstellungen, die der Nutzer erstellt hat, werden gelöscht.</p>
...
<ul class="index-list">
    <li>
        <p>Um Voreinstellungen zurückzusetzen, finden Sie den Tab 'Werkzeuge' (1). In dem DropDown Block öffnen Sie den
            Tab 'Einstellungen' (2).</p>
...
<p>Wenn Sie Skripte und Stile optimieren, werden Ausnahmen zu Modulen in dem Bereich Header hinzugefügt. Dadurch wird
    die Seitenladegeschwindigkeit erhöht. Die Optimierung funktioniert in dem Text-Modus.</p>
<p>Wie man die Optimierung aktiviert:</p>
<ul class="index-list">
    <li>
        <p>Um die Optimierung zu aktivieren, öffnen Sie den Tab 'Werkzeuge' (1) und wählen Sie den Tab 'Einstellungen'
            (2).</p>
...
<p>Wenn die Optimierung bei der Bearbietung und Aktivierung der Voreinstellungen aktiviert ist, wird die Optimierung
    zurückgesetzt, aber Sie sehen ein Fenster, in dem Sie die Optimierung durchführe können. Es gibt keine Notwendigkeit
    Skripte und Stile jedesmal zu optimieren, wenn Sie die die Änderungen an den Voreinstellungen vornehmen. Optimieren
    Sie sie besser nach der Bearbeitung.</p>
...
<ul class="index-list">
    <li>
        ...
        <ul class="marked-list">
            <li>background-image (Hintergrundbild) – der Wert ist der Link zum Bild. Es wird das Bild aus dem Ordner
                ~/images/cms/ verwendet.
            </li>
            <li>background-color (Hintergrundfarbe) – der Wert kann in jedem Farbformat (rgb, hex usw.) festgelegt
                werden. Sie können eine Farbe mit Hilfe von dem Werkzeug Farbwähler wählen.
            </li>
            <li>background-repeat (Hintergrund wiederholen) – alle verfügbaren Einstellungen sind als Radiobutton
                vorgestellt.
            </li>
            <li>background-position (Hintergrundposition) - alle verfügbaren Einstellungen sind als DropDown Liste
                vorgestellt.
            </li>
            <li>background-size (Hintergrundgröße) - alle verfügbaren Einstellungen sind als DropDown Liste
                vorgestellt.
            </li>
            <li>background-origin (der Platzierungsbereich eines benutzerdefinierten Bildes) - alle verfügbaren
                Einstellungen sind als DropDown Liste vorgestellt.
            </li>
        </ul>
    </li>
    <li><p>Stile der Grenze.</p>
        ...
        <ul class="marked-list">
            <li>border-top-style, border-right-style, border-left-style, border-bottom-style - alle verfügbaren
                Einstellungen sind als DropDown Liste vorgestellt.
            </li>
            <li>border-top-width, border-right-width, border-left-width, border-bottom-width – legen Sie den Wert in
                Pixel fest.
            </li>
            <li>border-top-right-radius, border-top-left-radius, border-bottom-right-radius, border-bottom-left-radius -
                legen Sie den Wert in Pixel fest.
            </li>
            <li>border-top-сolor, border-right-color, border-left-color, border-bottom-color – der Wert kann in jedem
                Farbformat (rgb, hex usw.) festgelegt werden. Sie können eine Farbe mit Hilfe von dem Werkzeug
                Farbwähler wählen.
            </li>
        </ul>
    </li>
...
<ul class="index-list">
    <li>
        <p>Um Stile des Elementes zu löschen, öffnen Sie den Bereich Stile und drücken Sie auf den Button 'Stile
            löschen' (1)</p>
...
<p>Wenn Sie das Modul Если Вы 'TM Mega Layout' löschen oder deaktivieren, werden alle verfügbaren voreinstellungen
    deaktiviert. Sie sehen die Positionen (Hooks) wie am Anfang.</p>