...
<?php if ($project == 'impresta') { ?>
    ...
    <!--    </div>-->
<?php } ?>
<p>Ce module est conçu pour vous permettre de créer des mises en page personnalisées (préréglages) pour les crochets et
    les afficher sur le site au lieu des positions par défaut.
...
<ul class="index-list">
    ...
    <li>
        ...
        <ul class="marked-list">
            ...
            <li>La position du module dans la section 'Modules et Services -> Positions' n'affecte pas le préréglage.
            </li>
            <li>Le module ne vous permet pas de configurer différents modules. Vous ne pouvez pas configurer les
                différents modules pour différents préréglages.
            </li>
        </ul>
    </li>
</ul>
<h6>Le module fournit une option pour changer la position du module et configurer la grille pour 3 crochets:
    displayTopColumn, displayHome, displayFooter.
    La modification de la position des modules dans la section 'Modules et Services -> Positions' n'affecte pas le
    préréglage.
...
<ul class="index-list">
    <li><p>TopColumn. Pour ajouter un préréglage personnalisé au crochet topColumn, vous devez effectuer les opérations
            suivantes:</p>
        <ul class="marked-list">
...
{/if}</pre>
    ...
    <li><p>Home. Pour ajouter un préréglage personnalisé au crochet Home, vous devez effectuer les opérations
            suivantes:</p>
        <ul class="marked-list">
...
{/if}</pre>
    ...
    <li><p>Footer. Pour ajouter un préréglage personnalisé au crochet Home, vous devez effectuer les opérations
            suivantes:</p>
        <ul class="marked-list">
            <li>Ouvrez le fichier <strong>/themes/your_theme/footer.tpl</strong> pour éditer.</li>
            <li>Recherchez le code suivant
...
{/if}
    ...
    <li><p>Header. Pour ajouter un préréglage personnalisé au crochet Header, vous devez effectuer les étapes
            suivantes:</p>
        <ul class="marked-list">
            <li>Ouvrez le fichier <strong>/themes/your_theme/header.tpl</strong> pour éditer.</li>
            <li>Recherchez le code suivant
...
{/if}</pre>
    ...
    <li><p>Productfooter. Pour ajouter un préréglage personnalisé au crochet Productfooter, vous devez effectuer les
            étapes suivantes:</p>
        <ul class="marked-list">
...
<ul class="index-list">
    <li>'Header' est un crochet qui combine 2 crochets standards: displayNav et displayTop. Ce crochet correspond à
        l'en-tête du site
    </li>
    ...
    <li>'Product Footer' correspond au crochet original displayFooterProduct, qui s'affiche dans pied de page de
        produit.
    </li>
</ul>
...
<p>Le panneau de configuration du module TM Mega Layout vous permet d'ajouter un préréglage au crochet requis et de
    configurer le préréglage.</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Ensuite, remplissez le champ "Entrez le nom de préréglage" dans la fenêtre contextuelle (2) et appuyez sur
            'Enregistrer' (3).</p>
        <figure class="img-polaroid"><img src="img/tmmegalayout-add-preset-2.png" alt=""/></figure>
    </li>
    <li>
        <p>Le préréglage a été créé avec succès, il est listé parmi les presets disponibles (4) maintenant. Le
            préréglage créé récemment est sélectionné pour l'édition (5).</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Le préréglage a été activé. Si vous devez afficher ce préréglage uniquement sur certaines pages, ouvrez le
            menu déroulant (3) et sélectionnez les pages dont vous avez besoin.
            Pour appliquer les modifications, cliquez en dehors de la zone de liste.
            Un préréglage affiché sur toutes les pages sera marqué avec une étoile remplie dans la liste des
            préréglages,
            et le préréglage, qui s'affiche uniquement sur certaines pages, sera marqué avec une étoile partiellement
            remplie.</p>
...
<p>L'ajout de la classe personnalisée vous permettra de créer un style spécifique pour votre wrapper en utilisant les
    règles css.</p>
<ul class="index-list">
    <li>
    ...
    <li>
        <p>Vous verrez une fenêtre contextuelle, remplissez le champ 'Entrer le classe de wrapper' (2) et appuyez sur le
            bouton 'Confirmer' (3).</p>
...
<p class="alert alert-warning">La suppression de l'élément préréglé entraînera aussi l'élimination de tous ses éléments
    enfants et leurs styles.</p>
<ul class="index-list">
    <li>
...
<ul class="index-list">
    ...
    <li>
        <p>Dans la fenêtre contextuelle, remplissez tous les champs requis (vous pouvez vous référer à la section
            "'tyling' de la documentation), et appuyez sur le bouton 'Enregistrer' (2).</p>
...
<ul class="index-list">
    <li>
        <p>Pour insérer une nouvelle rangée, appuyez sur '+ Ajouter une rangée' (1) dans le bloc du wrapper,
            ou '+ Ajouter une rangée' (2) dans le bloc du préréglage principal, ou '+ Ajouter une rangée' (3) dans la
            liste déroulante de colonne.</p>
...
<p>L'ajout de la classe personnalisée vous permettra de créer un style spécifique pour rangée en utilisant les règles
    css.</p>
<ul class="index-list">
    <li>
    ...
    <li>
        <p>Vous verrez une fenêtre contextuelle, remplissez le champ 'Entrer le classe de rangée' (2) et appuyez sur le
            bouton 'Confirmer' (3).</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Dans la fenêtre contextuelle, remplissez tous les champs requis (vous pouvez vous référer à la section
            'Styling' de la documentation), et appuyez sur le bouton 'Enregistrer' (2).</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Remplissez les champs (col-xs*, col-sm*, col-md*, col-lg - bootstrap classes) dans la fenêtre contextuelle et
            appuyez sur le bouton 'Confirmer' (3).</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Si nécessaire, vous pouvez entrer la classe personnalisée (3) dans la fenêtre contextuelle et sélectionner le
            module (4), appuyez ensuite sur 'Confirmer' (5).</p>
...
<ul class="index-list">
    <li>
        <p>Pour spécifier une classe personnalisée pour le module, ouvrez le menu dans le bloc de module (l'icône
            'ellipsis')(1).</p>
    ...
    <li>
        <p>Spécifiez la classe personnalisée (3) dans la fenêtre contextuelle et appuyez sur le bouton 'Confirmer'
            (4).</p>
...
<p>Les blocs de Logo et de Droits d'auteur sont modifiés de la même manière que les modules,
    Sauf que Logo ne peut être placé que dans la position de Header ou Footer, et le bloc Copyright peut être placé
    uniquement en position de Footer.</p>

<h4 class="text-secondary">Page de produit</h4>
<h5>Onglet Info de produit</h5>
<h6>Grâce à cet onglet, vous pouvez changer la mise en page de la page produit. Il apparaîtra dans le panneau
    d'administration après avoir effectué quelques actions simples décrites ci-dessous.</h6>
...
<ul class="index-list">
    ...
    <li>Dans le dossier de thème, retrouvez le fichier 'product.tpl', copiez-le dans le dossier récemment créé
        'product_pages' et renommez-le 'default.tpl'.
        Pour créer plusieurs mises en page - dupliquer ce fichier, renommez-le (par ex. 'layout_1.tpl', 'layout_2.tpl')
        et modifiez la structure selon vos besoins.
    </li>
  ...
  "default": {
    ...
    "default": 1
        ...
        <ul class="marked-list">
            ...
            <li>"name": <strong>"Default"</strong> - le titre de la mise en page de produit dans les paramètres du
                module.
            </li>
            <li>"preview": <strong>"default.jpg"</strong> - aperçu de la disposition de la page du produit dans les
                paramètres du module; l'image doit être placée dans le dossier 'product_pages'.
            </li>
            <li><p>"default": <strong>1</strong> - définissez '1' si la mise en page doit être définie par défaut</p>
                <br>
                <p class="alert small alert-warning">Une des mises en page devrait contenir une valeur '1' à définir
                    comme défaut.</p>
            </li>
        </ul>
        <p>Ce code devrait être dupliqué pour chaque disposition créée, et contenir des valeurs correspondantes. Par
            exemple:</p>
        <pre class="codebox">
{
  "default": {
...
{/if}</pre>
    ...
    <li>Pour ajouter/modifier les styles de la disposition d'une page de produit, accédez à your_theme_folder/css/ et
        ajoutez un nouveau dossier 'product_pages'.
        Dans ce dossier, créez un fichier avec le nom de disposition et l'extension .css (par ex. 'default.css',
        'layout_1.css', 'layout_2.css').
        Ces fichiers doivent contenir des styles de la disposition de la page de produit correspondante.
    </li>
    <li>Pour ajouter des scripts à la disposition d'une page de produit, allez à your_theme_folder/js/ et ajoutez un
        nouveau dossier 'product_pages'.
        Dans ce dossier, créez un fichier avec le nom de disposition et l'extension .js (par ex. 'default.js',
        'layout_1.js', 'layout_2.js').
        Ces fichiers doivent contenir des scripts de la disposition de la page de produit correspondante.
    </li>
</ul>
...
<p>Dans cet onglet, vous pouvez changer les présentations de la page produit. L'image de mise en page avec la bordure
    grise est définie par défaut.</p>
...
<ul class="index-list">
    ...
    <li>
        <p>Afin de prévisualiser le préréglage, appuyez sur le bouton 'Aperçu' (3) près du préréglage dont vous avez
            besoin.
...
<p class="alert alert-warning">L'outil Importer n'accepte que les fichiers * .zip prédéfinis, qui ont été générés
    précédemment avec le même module (l'outil Exporter).</p>
<ul class="index-list">
    <li>
    ...
    <li>
        <p>Appuyez ensuite sur le bouton <strong>Ajouter un fichier (3)</strong> et sélectionnez le fichier zip de votre
            exportation.</p>
        <figure class="img-polaroid"><img src="img/tmmegalayout-import-preset-2.png" alt=""/></figure>
    </li>
    <li>
        <p>Si ce préréglage répond à vos besoins, appuyez sur <strong>'Importer' (4)</strong>. Ce préréglage sera
            importé et ajouté à la liste des préréglages disponibles.</p>
        <figure class="img-polaroid"><img src="img/tmmegalayout-import-preset-3.png" alt=""/></figure>
    </li>
</ul>

<h5>Réinitialiser</h5>
<p>Réinitialiser - réinitialise tous les préréglages à leur état initial (car ils ont été fournis avec le thème), tous
    les préréglages personnalisés, créés par l'utilisateur seront supprimés.</p>
<p class="alert alert-warning">Attention! After restoring the default presets, all of the custom presets will be
    removed!</p>
<ul class="index-list">
    <li>
...
<p>L'optimisation des styles et des scripts ajoute des exclusions pour les modules dans la section Header, en fonction
    de leur utilisation dans les préréglages.
...
<p>Si l'optimisation est activée lors de l'édition et de l'activation des préréglages, l'optimisation est rejetée, mais
    vous verrez une fenêtre, offrant d'exécuter l'optimisation.
...
<ul class="index-list">
    <li>
        ...
        <ul class="marked-list">
            <li>background-image (image de fond) - l'argument est un lien vers l'image. L'image est choisie dans le
                dossier ~/images/cms/.
            </li>
            <li>background-color (couleur de fond) - le valeur peut être définie en tout format de couleur (rgb, hex,
                etc.). Vous pouvez choisir la couleur à l'aide de l'outil 'Sélecteur de couleurs'.
            </li>
            <li>background-repeat (répétition du fond) - toutes les options disponibles sont listées dans la liste
                déroulante.
            </li>
            <li>background-position (position de fond) - toutes les options disponibles sont listées dans la liste
                déroulante.
            </li>
            <li>background-size (taille de fond) - toutes les options disponibles sont listées dans la liste
                déroulante.
            </li>
            <li>background-origin (région de positionnement d'image de fond) - toutes les options disponibles sont
                listées dans la liste déroulante.
            </li>
        </ul>
    </li>
    <li><p>Styles de bordure.</p>
        ...
        <ul class="marked-list">
            <li>TYPE: border-top-style, border-right-style, border-left-style, border-bottom-style - toutes les options
                disponibles sont listées dans la liste déroulante.
            </li>
            <li>LARGEUR: border-top-width, border-right-width, border-left-width, border-bottom-width - devrait être
                configuré en pixels.
            </li>
            <li>RADIUS: border-top-right-radius, border-top-left-radius, border-bottom-right-radius,
                border-bottom-left-radius - should be set in pixels.
            </li>
            <li>COULEUR: border-top-сolor, border-right-color, border-left-color, border-bottom-color - le valeur peut
                être définie en tout format de couleur (rgb, hex, etc.). Vous pouvez choisir la couleur à l'aide de
...
<ul class="index-list">
    <li>
        <p>Pour supprimer les styles d'élément, ouvrez la section de style et appuyez sur le bouton 'Effacer les styles'
            (1).</p>
...
<p class="alert alert-warning">Dans le cas où vous supprimez ou désactivez le module 'TM Mega Layout', tous les
    préréglages actifs seront désactivés et vous verrez les positions (crochets) dans leur apparence originale.</p>